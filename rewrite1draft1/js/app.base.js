...
/*
	...
	bool ignore_custom: to ignore custom click fns
*/
app.click = function(t, ignore_custom) {
	if(typeof data.url.custom_click[t] == 'function' && (typeof ignore_custom=='undefined'||ignore_custom==false)) {
		return data.url.custom_click[t]();
	} else if(typeof data.url.custom_click[t] == 'string' && (typeof ignore_custom=='undefined'||ignore_custom==false)) {
