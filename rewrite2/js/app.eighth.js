if(typeof eighth=='undefined') eighth = {};

eighth.genCard = function(d) {
	if(typeof d.noact != 'undefined') {
		return "<div class='eighth-card' card-data='" + JSON.stringify(d) + "'><b>" + d.block + "</b><label>No activity selected</label><div class='bot'></div><div class='more'><br /><span><a href='eighth/signup/" + d.day + "/" + d.block + "/'>View other activities</a><a class='roster' href='eighth/roster/" + d.day + "/" + d.block + "/" + d.aid + "'>View roster</a></span></div>";
	}
	return "<div class='eighth-card' card-data='" + JSON.stringify(d) + "'><b>" + d.block + "</b><label>" + d.title + "</label><div class='bot'><span class='sponsor'>" + d.sponsor + "</span><span class='room'>" + d.room + " (" + d.signedup + "/" + d.capacity + ")</span></div><div class='more'><br /><span><a href='eighth/signup/" + d.day + "/" + d.block + "/'>View other activities</a><a class='roster' href='eighth/roster/" + d.day + "/" + d.block + "/" + d.aid + "'>View roster</a></span></div>";
};

eighth.homeNext = function() {
	console.log('Loading next eighth page');
	$b = $('.main-home .eighth .schedule .day-more');
	$b.html(data.strings.loadGif);
	$c = $('.main-home .eighth .schedule');
	$c.html(data.loadMsg);
};
